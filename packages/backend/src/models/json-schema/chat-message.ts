	...
	properties: {
		...
		reply: {
			...
			properties: {
				...
				text: { type: 'string', optional: true, nullable: true },
				fromUserId: { type: 'string', optional: false, nullable: false },
				fromUsername: { type: 'string', optional: true, nullable: true },
				fromName: { type: 'string', optional: true, nullable: true },
				fromUser: { type: 'object', optional: true, nullable: true, ref: 'UserLite' },
			},
		},
	},
} as const;

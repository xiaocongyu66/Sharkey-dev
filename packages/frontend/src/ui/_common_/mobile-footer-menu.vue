...
<div ref="rootEl" :class="$style.root">
	...
	<button v-else :class="$style.item" class="_button" @click="widgetsShowing = true">
		<div :class="$style.itemInner">
...
const menuIndicated = computed(() => {
	for (const def in navbarItemDef) {
		...
		if (def === 'chat' && chatAvailable.value) continue; // chat is on the footer

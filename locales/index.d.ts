...
export interface Locale extends ILocale {
    ...
    "_chat": {
        ...
        "mutedAll": string;
        /**
         * オーナー、ルーム管理者、およびインスタンスのモデレーターのみ発言できます。
         */
        "mutedAllHint": string;
        /**
         * 全体ミュート中のため、メッセージを入力・送信できません。
         */
        "mutedAllComposerDisabled": string;
        /**
         * 参加ポリシー
         */
        "joinPolicy": string;
         ...
         * 公開（ルームリンクがあれば参加可）
         */
        "joinPolicyPublic": string;
        /**
         * リンク / 招待コード
         */
        "joinPolicyLink": string;
        /**
         * 招待のみ
         */
        "joinPolicyInvite": string;
        /**
         * 参加不可
         */
        "joinPolicyClosed": string;
        /**
         * 招待コードで参加
         */
         ...
         * そのまま参加できます。
         */
        "canJoinDirectly": string;
        /**
         * 招待コードを入力して参加してください。
         */
        "needInviteCodeToJoin": string;
        /**
         * オーナーまたは管理者の招待が必要です。
         */
        "needInvitationToJoin": string;
        /**
         * このルームは現在参加を受け付けていません。
         */
        "joiningClosed": string;
        /**
         * 参加中…
         */
        "joining": string;
         ...
         * 参加するにはログインが必要です
         */
        "signinToJoinRoom": string;
        /**
         * このリンクを開くにはアカウントが必要です。ログイン後に参加・閲覧できます。
         */
        "signinToJoinRoomHint": string;
        /**
         * スタンプ
         */
        "stickers": string;
        /**
         * スタンプパックはまだありません。Telegram パックをインポートするか（TELEGRAM_BOT_TOKEN が必要）、パックを作成して画像を追加してください。
         */
        "noStickersYet": string;
        /**
         * インポート
         */
        "importTelegram": string;
        /**
         * オーナー
         */
        "roleOwner": string;
        ...
        "manage": string;
        /**
         * オーナー、ルーム管理者、およびインスタンスのモデレーターが設定できます。
         */
        "manageHint": string;
        /**
         * 全体ミュート・お知らせ・メッセージ削除・ルーム削除は「管理」タブで操作します。
         */
        "manageInManageTab": string;
        /**
         * ルーム設定
         */
        "roomSettings": string;
        ...
        /**
         * このルームの全メッセージを永久に削除します。
         */
        "clearMessagesHint": string;
        /**
         * このルームのメッセージをすべて削除しますか？元に戻せません。
         */
         ...
         * 暗号化に失敗しました。
         */
        "e2eeEncryptFailed": string;
        /**
         * 復号できません（鍵がありません）。
         */
        "e2eeDecryptFailed": string;
        /**
         * 🔒 暗号化メッセージ
         */
         ...
         * この発言者の最近のメッセージ
         */
        "recentFromSpeaker": string;
        /**
         * キーワード検索、発言者の指定ができます。発言者のみ指定するとその人の最近のメッセージを表示します。結果をタップでチャット内にジャンプします。
         */
        "searchOrSpeakerHint": string;
        /**
         * メッセージへ移動中…
         */
    ...
    "_xAlgorithm": {
        ...
        "title": string;
        /**
         * X Algorithm はオリジナルの上流サービスとして動作する必要があります。Sharkey は Home Mixer/Scored Posts を HTTP ゲートウェイ経由で呼び出し、ローカルで簡易アルゴリズムをエミュレートしません。
         */
        "info": string;
        /**
         * X Algorithm を有効化
        ...
        "enable": string;
        /**
         * 推薦バックエンドとして xai-org/x-algorithm を使用します。
         */
        "enableCaption": string;
        /**
         * 厳格なオリジナル体験
         */
        "strictOriginal": string;
        /**
         * 欠落した X Algorithm 段階を Sharkey のヒューリスティックで黙って置き換えません。
         */
        "strictOriginalCaption": string;
        /**
         * Sharkey タイムラインへフォールバック
         */
        "fallback": string;
        /**
         * 上流サービスの立ち上げ中のみ使用してください。
         */
         ...
         * {n} 件のノート ID を返しました。
         */
        "testResult": ParameterizedString<"n">;
        /**
         * オリジナルサービス
         */
        "originalServices": string;
        /**
         * Home Mixer HTTP ゲートウェイ
         */
        "homeMixer": string;
        /**
         * Scored Posts HTTP ゲートウェイ
         */
        "scoredPosts": string;
        /**
         * Phoenix エンドポイント
         ...
         * Thunder インネットワークソース
         */
        "includeInNetwork": string;
        /**
         * Phoenix アウトオブネットワークソース
         */
        "includeOutOfNetwork": string;
        /**
         * Grox コンテンツ理解
         */
        "enableGrox": string;
    ...
    "_adminNotes": {
        ...
        "siteWide": string;
        /**
         * ローカルユーザーのノート作成を制御します。無効時もモデレーター/管理者は投稿できます。
         */
        "siteWideCaption": string;
        /**
         * ローカル投稿をすべて禁止
         */
        "disableLocalNoteCreation": string;
        /**
         * 有効にするとモデレーター以外のローカルユーザーはノートを作成できません。
         */
        "disableLocalNoteCreationCaption": string;
        /**
         * 全ローカルユーザーの投稿を禁止しますか？モデレーターは投稿できます。
         */
    ...
    "_uiCommon": {
         ...
         * AP受信（inbox）
         */
        "apInboxReceived": string;
        /**
         * AP配信（成功）
         */
        "apDeliverSucceeded": string;
        /**
         * AP配信（失敗）
         */
        "apDeliverFailed": string;
        /**
         * 送信: 成功
         */
        "apOutSucc": string;
    ...
    "_themeNames": {
         ...
         * Light (default)
         */
        "4eea646f-7afa-4645-83e9-83af0333cd37": string;
        /**
         * Dark (default)
         */
        "8050783a-7f63-445a-b270-36d0f6ba1677": string;
        /**
         * Coffee Light
         */
        "6ed80faa-74f0-42c2-98e4-a64d9e138eab": string;
        /**
         * Apricot Light
         */
        "0ff48d43-aab3-46e7-ab12-8492110d2e2b": string;
        /**
         * Rainy Light
         */
        "a58a0abb-ff8c-476a-8dec-0ad7837e7e96": string;
        /**
         * Botanical Light
         */
        "1100673c-f902-4ccd-93aa-7cb88be56178": string;
        /**
         * Vivid Light
         */
        "6128c2a9-5c54-43fe-a47d-17942356470b": string;
        /**
         * Cherry Light
         */
        "ac168876-f737-4074-a3fc-a370c732ef48": string;
        /**
         * Sushi Light
         */
        "213273e5-7d20-d5f0-6e36-1b6a4f67115c": string;
        /**
         * U0 Light
         */
        "e2c940b5-6e9a-4c03-b738-261c720c426d": string;
        /**
         * Persimmon Dark
         */
        "c503d768-7c70-4db2-a4e6-08264304bc8d": string;
        /**
         * Astro Dark
         */
        "080a01c5-377d-4fbb-88cc-6bb5d04977ea": string;
        /**
         * Future Dark
         */
        "32a637ef-b47a-4775-bb7b-bacbb823f865": string;
        /**
         * Botanical Dark
         */
        "504debaf-4912-6a4c-5059-1db08a76b737": string;
        /**
         * Green+Lime Dark
         */
        "02816013-8107-440f-877e-865083ffe194": string;
        /**
         * Green+Orange Dark
         */
        "dc489603-27b5-424a-9b25-1ff6aec9824a": string;
        /**
         * Cherry Dark
         */
        "679b3b87-a4e9-4789-8696-b56c15cc33b0": string;
        /**
         * Ice Dark
         */
        "66e7e5a9-cd43-42cd-837d-12f47841fa34": string;
        /**
         * U0 Dark
         */
        "7a5bc13b-df8f-4d44-8e94-4452f0c634bb": string;
        /**
         * Rosé Pine
         */
        "3cdfd635-4d5e-4d06-9ba3-20f123f0999b": string;
        /**
         * Rosé Pine Dawn
         */
